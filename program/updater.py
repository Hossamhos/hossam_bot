...
def gen_chlog(repo, diff):
    upstream_repo_url = Repo().remotes[0].config_reader.get(
        "url").replace(".git", "")
...
async def update_repo(_, message: Message):
    ...
    if update_avail:
        ...
        return
    await msg.edit("bot is **up-to-date** with [main](https://github.com/riskykillerbhan5/video-stream/tree/main)", disable_web_page_preview=True)
