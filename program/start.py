...
async def start_(client: Client, message: Message):
    await message.reply_photo("https://telegra.ph/riskykiller-Bhan-12-06")
...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🌐 Source Code", url="https://github.com/riskykillerbhan4/Video-Bot"
                    )
                ],
            ]
        ),
...
@Client.on_message(
    command(["alive", f"alive@{BOT_USERNAME}"]
            ...
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                "👤 Assistant", url=f"https://t.me/{ass_uname}")
                        ]
                    ]
                )
            )
