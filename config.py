...
ALIVE_NAME = getenv("ALIVE_NAME", "riskykiller")
BOT_USERNAME = getenv("BOT_USERNAME", "JennieKimMusicBot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "riskykillerbhan9")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "LisaSupportBot")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "riskykillerhelpbot")
SUDO_USERS = list(map(int, getenv("SUDO_USERS").split()))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
ALIVE_IMG = getenv(
    "ALIVE_IMG", "https://te.legra.ph/file/de3dce819a91c99243f9e.jpg")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "60"))
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO", "https://github.com/riskykillerbhan4/video-Bot")
